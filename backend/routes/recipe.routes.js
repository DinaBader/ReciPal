...
const {addRecipe,getRecipeByCategory,deleteRecipe,searchRecipes,addRecipePhoto,getRecipe,update_image,getRecipeById,getRecipeByIngredients}=require("../controllers/recipe.controllers");
...
router.get('/getRecipeByCategory', getRecipeByCategory);
